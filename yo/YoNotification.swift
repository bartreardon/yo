...
class YoNotification: NSObject {
    ...
    init (arguments: YoCommandLine) {
        ...
        if arguments.sender.value != nil {
            bundleIdentifier = arguments.sender.value!
        }
        ...
        // makes sure buttons are displayed on the notification
        notification.setValue(true, forKey: "_showsButtons")
        ...
        if (arguments.messageText.value != nil) {
            notification.informativeText = arguments.messageText.value
        } else {
